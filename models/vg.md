...
In average climate control, the base heating setpoint $${\mathbb{S}_\text{{heat}}^\text{{base}}}$$ (&deg;C) is updated regularly (e.g., at midnight) to reflect the average greenhouse temperature $$\overline{T_{in}}$$  (&deg;C) (e.g., over the last 48 hours). The average heating setpoint $${\mathbb{S}_\text{{heat}}^\text{{avg}}}$$ (&deg;C) regulates $${\mathbb{S}_\text{{heat}}^\text{{base}}}$$ in steps of $$\Delta
$$
\text{if}\quad \overline{T_{in}} > {\mathbb{S}_\text{{heat}}^\text{{avg}}} \quad
...
$$
C_{air} = 1\,020 \frac{\text{J}}{\text{K}\cdot
\cdot 1.19\frac{\text{kg}}{\text{m}^3} 
\cdot 3.94 \frac{\text{m}^3}{\text{m}^2} 
= 4\,780 \frac{\text{J}}{\text{K}\cdot
$$
...
$$
\begin{equation}
C_{glass}^{cond} = C_{ai}c\left
\label{eq_condensation}
\end{equation}
$$
with units
$$
\left[\frac{\text{kg}}{\text{m}^2\text{ ground}\cdot
\left[\frac{\text{m}^2\text{ cover}}{\text{m}^2\text{ ground}}\right] \cdot
\left[\frac{\text{m}^3}{\text{m}^2\text{ cover}\cdot
...
$$
1.29\frac{\text{ mg CO}_2}{\text{m}^2\text{ leaf}\cdot
...
$$
\begin{split}
1\left[\frac{\text{g}}{\text{m}^2\cdot
1\left[\frac{\text{g}}{\text{m}^2\cdot
\frac{A_{gh}}{V_{gh}}\left[\frac{\text{m}^2}{\text{m}^3}\right] \\[6pt]
&= 
\frac{A_{gh}}{V_{gh}} \left[\frac{\text{g}}{\text{m}^3\cdot
\end{split}
$$
and
$$
...
10^{-6}\left[\frac{\text{mol}}{\mu
3\,600\left[\frac{\text{s}}{\text{h}} \right] \\[6pt] 
&= 0.1584\frac{A_{gh}}{V_{gh}} \left[\frac{\text{g}}{\text{m}^3\cdot
\end{split}
$$
...
$$
\frac{1}{g_t} = \frac{1}{g_b}+\frac{1}{g_s} \quad
